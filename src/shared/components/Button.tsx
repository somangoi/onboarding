...
export function Button({
  ...
  const baseStyles = "px-8 py-3 rounded-full text-[var(--font-size-button)] font-[var(--font-weight-button)] transition-all duration-200  disabled:cursor-not-allowed cursor-pointer";
